...
# UWWの曲のみで作ったルール
# A_M1_Ver1.RuleList = ['メロディ','ドラム','メロディ','メロディ','ボーカル','ボーカル','メロディ','ボーカル','ドラム','ボーカル','メロディ','None']
# A_M1_Ver1.RuleList = ['メロディ','ドラム','メロディ','メロディ','ボーカル','ボーカル','ボーカル','ボーカル','ドラム','ボーカル','メロディ','None']
